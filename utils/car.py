...
from vtkmodules.vtkCommonCore import vtkIdList, vtkDoubleArray
from vtkmodules.vtkFiltersCore import vtkPolyDataNormals, vtkPointDataToCellData
...
def cal_coefficient(file_name, press_surf=None, velo_surf=None):
    root = '/hpc2hdd/home/zli416/jhaidata/DATA/Geo/car_cfd/training_data'
